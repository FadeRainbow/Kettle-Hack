...
public class ShaderCharms  extends Module {
    ...
    public final ModeSetting<ShaderModes> mode = registerSetting("Mode", ShaderModes.Space);
    ...
    public enum ShaderModes {
        AQUA, RED, SMOKE, FLOW, ITEMGLOW, PURPLE, GRADIENT, UNU, GLOW, OUTLINE, BlueFlames, CodeX, Crazy, Golden, HideF, HotShit, Kfc, Sheldon, Smoky, SNOW, Techno,Space
    }
}
