        ...
        if (mode.getValue().equals(Mode.TwoDee)) {
            for (Entity e : ESP.mc.world.loadedEntityList) {
                ...
                if (tag.getValue()) {
                    ...
                    Cube.fontManager.CustomFont.drawStringWithShadow(e.getName(), (float) (1 - ESP.mc.fontRenderer.getStringWidth(e.getName()) / 2), -170.0f, -1);
                    GL11.glDisable((int)3553);
                }
                if (healthValue.getValue()) {
                    if(health.getValue()) {
                        GL11.glEnable((int) 3553);
                        Cube.fontManager.CustomFont.drawStringWithShadow(String.valueOf((int) (((EntityPlayer) e).getHealth() / ((EntityPlayer) e).getMaxHealth() * 100.0f)), (float) (-50 - ESP.mc.fontRenderer.getStringWidth(String.valueOf((int) (((EntityPlayer) e).getHealth() / ((EntityPlayer) e).getMaxHealth() * 100.0f)))), (float) ((int) ((double) (((EntityLivingBase) e).getHealth() / ((EntityLivingBase) e).getMaxHealth()) * ((double) e.height + 0.2))), -1);
                        GL11.glDisable((int) 3553);
                    }
                }
                if (showItem.getValue() && !(((EntityPlayer)e).getHeldItem(EnumHand.MAIN_HAND).getItem() instanceof ItemBlock) && !(((EntityPlayer)e).getHeldItem(EnumHand.MAIN_HAND).getItem() instanceof ItemAir)) {
                    GL11.glEnable((int)3553);
                    Cube.fontManager.CustomFont.drawStringWithShadow(((EntityPlayer) e).getHeldItem(EnumHand.MAIN_HAND).getDisplayName(), (float) (1 - ESP.mc.fontRenderer.getStringWidth(((EntityPlayer) e).getHeldItem(EnumHand.MAIN_HAND).getDisplayName()) / 2), 20.0f, -1);
                    GL11.glDisable((int)3553);
                }
