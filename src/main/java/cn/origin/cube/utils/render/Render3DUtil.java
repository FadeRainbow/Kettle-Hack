...
import cn.origin.cube.inject.client.AccessorRenderManager;
...
public class Render3DUtil extends Tessellator {
    ...
    public static void drawText(Vec3d vec3d, String text, Color color) {
        ...
        GlStateManager.translate(-(Cube.fontManager.CustomFont.getStringWidth(text) / 2.0), 0.0, 0.0);
        Cube.fontManager.CustomFont.drawStringWithShadow(text, 0.0f, 0.0f, color.getRGB());
    ...
    public static void glBillboard(double x, double y, double z) {
        ...
        GlStateManager.translate(x - ((AccessorRenderManager)Minecraft.getMinecraft().getRenderManager()).getRenderPosX(), y - ((AccessorRenderManager) Minecraft.getMinecraft().getRenderManager()).getRenderPosY(), z - ((AccessorRenderManager) Minecraft.getMinecraft().getRenderManager()).getRenderPosZ());
    ...
    public static void drawBlockBBFullBox(BlockPos blockPos, float scale, int color) {
        ...
        drawBetterBoundingBoxFilled(INSTANCE.getBuffer(), bb, new Vec3d(blockPos.getX() + 0.5f, blockPos.getY() + 0.5f, blockPos.getZ() + 0.5f), scale, r, g, b, a);
    }
